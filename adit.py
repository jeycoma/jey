...
nadya = LINETCR.LINE()
nadya.login(token="EqZ9g1OiLOzP7vHdHum2.f2pIS/ryci+ZwP+cOeIGSG.yVnehDM0r8qAVlKY76c0YnlSgK6hfh0Cd+DXEmL2NME=")
...
def bot(op):
    try:
		...
		if msg.from_ in admin:
		    ...
		    nadya.sendText(msg.to,"Khusus A")
