...
import RIKOSELFBOT
from RIKOSELFBOT.lib.curve.ttypes import *
...
cl = RIKOSELFBOT.LINE()
cl.login(token="EoCMC94fRmKSpnJbTvK6.8v9J1XRqfIW/ErZtXU+kLG.OFhnwZ82O73JKCy0BmDfsdibA9wXzaZtc2io/98G+Q4=")
cl.loginResult()

ki = RIKOSELFBOT.LINE()
ki.login(token="EoXGLPQOiwS7Wk0Hj6de.3S/qsZ/0tT0q4pz9Q1uPdG.b6Itm3LzbGSLkQqI56PFW+8FKTXIGi7jdhrgTpWe0c8=")
ki.loginResult()

ag = RIKOSELFBOT.LINE()
ag.login(token="EoNXtEI2uiquZ4xGi4Tc.wYZMLex6siyZt78zESO8+a.SeES5zs77Js9ZzoLUw/WlpEP+IJ7HY7QzB7mCfsVw9w=")
ag.loginResult()
...
admin=["uf15f63d71ad0162c3e791cd3c6efca96","u07ea2f62eca2f29db2a22edb34c62f63","u81acb7e1e964063dc3cfbec063d22bc6"]
owner=["uf15f63d71ad0162c3e791cd3c6efca96"]
staff=["u81acb7e1e964063dc3cfbec063d22bc6","u07ea2f62eca2f29db2a22edb34c62f63"]
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"Thnx for add me mastah 😏",
    "lang":"JP",
    "comment":"",
    "commentOn":False,
    "commentBlack":{},
...
#----------------------------------------------------------
                ...
                cl.sendText(msg.to,"RIKO~BOT WAS HERE!!")
                ki.sendText(msg.to,"RIKO~BOT WAS HERE!!")
                ag.sendText(msg.to,"RIKO~BOT WAS HERE!!")
                cl.sendText(msg.to,"✍R̯̙̱͇̗̼̉̎͊̇̎̕͟͟͡I̛̮̝̖̾͌͂̄̈́̍̅̅̄͜͜K̨͎̺͚̘̻̬̱̲̉͒̅̽̾͝Ǫ̷̛͉̙͖͈̯̙͓͍̋͑̐̕͘͢͝͞ S̶̙̯̺̤̠̦̻̃̆͆̽͒̏͌̅͛͢E̡̨̡͕͇̲̼̐̾̆̓̐̄̒̽͝L̮͖͍̭̗̅̑́͆͒̔̈͢͠͞F̵̣̱̪͓̙̀̀̐̅̌̂͘̚͟͜͝͞B̴̛̝̳̱̬̙̓̅̈́̿̿̚͢O̠̺̙͇̫̹̘͕̅̑̇̏̚͞͠Ṫ̵͉͚̱͖̰̉̏̊̉̓̆̇͟͜͠☞")                              
#==============================================================================#                                                                                  
